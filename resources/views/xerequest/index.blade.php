...
@section('title', 'Xe Request')
@section('content')
<div class="row">
    <div class="col s6 m6 l6">
        <div class="page-title">XE Requests</div>
    </div>
    <div class="col s12 m12 l12">
        <div class="card">
            <div class="card-content">
                <span class="card-title">
                    <a class="waves-effect waves-light btn" onclick="exportExcel()">Export XE Request</a>
                </span>
...
function exportExcel()
{
    ...
    if (ids.length === 0) {
        Materialize.toast('Error- Select one or more records!!!', 2000, 'red rounded');
        return;
    }

    $.ajax({
        url: "{{route('xerequest.filter')}}",
        type: "POST",
        ...
        success: function(response) {
            if(response['success'] > 0){
                window.location.href = "{{route('xerequest.export')}}";
            }
        }
    });
}
