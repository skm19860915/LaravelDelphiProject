...
use App\Exports\TrackingGeneralView;
use DB;
...
class TrackingGeneralController extends Controller
{
    public function index()
    {
        ...
        return view('tracking-general.index', ['xerequests' => $xerequests]);
    }

    public function export()
    {
        return Excel::download(new TrackingGeneralView(), 'Tracking General '.now()->format('Y-m-d').'.xlsx');
    }
}
