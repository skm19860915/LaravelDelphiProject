...
class XeRequestController extends Controller
{
    public function index()
    {
        ...
        return view('xerequest.index', ['xerequests' => $xerequests]);
    }
    ...
    public function export()
    {
        ...
        return Excel::download(new XeRequest($ids), 'XERequest '.now()->format('Y-m-d').'.xlsx');
    }
