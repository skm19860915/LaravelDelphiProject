...
use App\Exports\TrackingReportView;
use DB;
...
class TrackingReportController extends Controller
{
    public function index()
    {
        ...
        return view('tracking-report.index', ['xerequests' => $xerequests]);
    }
    ...
    public function export()
    {
        ...
        return Excel::download(new TrackingReportView($ids), 'Tracking Report '.now()->format('Y-m-d').'.xlsx');
    }
}
