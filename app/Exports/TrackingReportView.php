...
class TrackingReportView implements FromView, ShouldAutoSize
{
    private $ids;
    ...
    public function view(): View
    {
        ...
        ON os.id = tt.order_id WHERE os.cancelled = 0 AND tt.gi_tons IS NOT NULL AND '.substr($query, 4).' ORDER BY os.id desc');

        return view('tracking-report/excel', ['list' => $list]);
    }
}
